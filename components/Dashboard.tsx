...
import { 
  ...
  Settings, LogOut, Menu, X, Bell, Sparkles
} from 'lucide-react';
...
const Dashboard: React.FC<DashboardProps> = ({ onLogout }) => {
  ...
  const navItems = useMemo(
    () =>
      ...
      ] as Array<{ id: string; label: string; icon: typeof LayoutDashboard }>,
    []
  );
